	...
	public void publish() {
		if( subscribers.size() > 0 ) {
			...
			while ( eventIterator.hasNext() ) {
				( (LaneObserver) eventIterator.next()).receiveLaneEvent( party, bowlIndex, currentThrower, currentCumulScores.getCumulScores(), scores, frameNumber+1, curScores, ball, gameIsHalted,initial_halt,game_completed);
			}
		}
	}
